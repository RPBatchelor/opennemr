...
The goal of {opennemr} is to provide simple access to the Open Electricity (formerly OpenNEM) API via R.

The [OpenElectricity project](https://openelectricity.org.au/) aims to make Australian energy 
...
to OpenElectricity. Each of the endpoints documented in the [API documentation](https://api.opennem.org.au/docs) 
...
To use {opennemr} you will need an API key from OpenElectricity. 
You can request access from the [OpenElectricity developer platform](https://platform.openelectricity.org.au)
...
It is recommended that you save your API key in your system environment, and don't push this to public repositories such as GitHub. 
...
Once you have done this, restart your R session and then run the below function from the {opennemr} pacakge
...
## Disclaimer
The {opennemr} pacakge is not associated with the OpenElectricity team, and has been 
...
noted on the OpenElectricity website. 
